...
public class SubAreaProcessorImpl implements SubAreaProcessor {
	// AclfNetwork object
	 ...
	 */
	public SubAreaProcessorImpl(AclfNetwork net) {
		this.net = net;
	 ...
	 */
	public SubAreaProcessorImpl(AclfNetwork net, CuttingBranch[] cuttingBranches) {
		this(net);
